...
The Linux compatibility CLI currently implements:
...
All major DiskPart command names are also recognized. Commands that are not implemented yet are accepted and reported as Linux compatibility stubs.
